...
import { parse_color, rgb_to_hex, format_color, rgb_to_hsv, hsv_to_rgb } from '../../utils/color';
...
for (const preset of PRESET_COLORS) {
    ...
    PRESET_HSV_CACHE.set(preset, rgb_to_hsv(r, g, b));
}
...
export function ColorPicker({ color, on_change, on_close }: ColorPickerProps) {
    ...
    useEffect(() => {
        ...
        if (parsed) {
            const [h, s, v] = rgb_to_hsv(parsed.r, parsed.g, parsed.b);
            dispatch({
                type: 'INIT',
                hue: h,
                saturation: s,
